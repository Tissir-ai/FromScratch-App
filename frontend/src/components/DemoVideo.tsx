const DemoVideo = () => {
    return (
        <section className="relative py-24 bg-gradient-to-b from-background to-feature-background overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="group relative rounded-2xl border border-feature-border bg-card/60 backdrop-blur-sm shadow-large overflow-hidden">
                        ...
                        {/* Footer bar */}
                        <div className="flex items-center justify-between px-4 sm:px-6 py-3 bg-background/60 border-t border-feature-border">
