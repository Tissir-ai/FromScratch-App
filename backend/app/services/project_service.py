...
async def create_project_with_roles(payload: object, current_user: object) -> Project:
    ...
    role_templates = {
        "Owner": [
            ...
            "view_dashboard",
            "view_overview",
            "view_diagrams","create_diagrams","edit_diagrams","delete_diagrams",
            "view_tasks","create_tasks", "edit_tasks", "delete_tasks",
            "view_requirements","create_requirements","edit_requirements", "delete_requirements",
            "view_reports","download_reports",
        ],
        "Manager": [
            "view_diagrams",
            "create_diagrams","edit_diagrams",
